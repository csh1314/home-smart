...
```
  ...
  ┌─────────────────────────────────────────────────────┐
  │  1. 关闭所有灯：                                      │
  │     客厅主灯 → 关   客厅射灯 → 关   客厅灯带 → 关     │
  │     餐厅灯 → 关     走廊灯 → 关     厨房灯 → 关       │
  │     公卫顶灯 → 关   公卫镜前灯 → 关  主卫灯 → 关      │
  │     卧室A灯 → 关    卧室A辅灯 → 关                    │
  │     卧室B灯 → 关    卧室B辅灯 → 关                    │
  │     主卧灯 → 关                                       │
  │                                                       │
...
```
  ...
  ⚠️ 注意：这条自动化会在任何时候氛围灯开启后 5 分钟关灯
  如果你平时也会单独用氛围灯，建议改为：
  → 生效时间段设为 22:00 - 06:00（只在夜间生效）
```
