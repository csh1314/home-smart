...
::: tip 推荐多买键数！
多出来的键可以通过米家 App 绑定为场景按钮（全屋关灯、睡眠模式、回家/离家等）。后期把灯换成智能灯后，开关可以完全脱离继电器变成纯无线场景控制器，可玩性极高。
...
| 位置   | 实际灯路 | 购买键数 | 多出场景键 | 说明                                    |
|--------|---------|---------|-----------|----------------------------------------|
| 客厅   | 3路     | **四键** | +1        | 主灯+射灯+灯带，多1键绑"离家模式"等       |
| 餐厅   | 1路     | **三键** | +2        | 餐厅灯，多2键绑场景                       |
| 主卧   | 2路     | **四键** | +2        | 主灯+氛围灯，多2键绑"睡眠""起床"模式      |
| 卧室A  | 2路     | **四键** | +2        | 主灯+辅灯，多2键绑场景                    |
| 卧室B  | 2路     | **四键** | +2        | 主灯+辅灯，多2键绑场景                    |
| 厨房   | 1路     | **三键** | +2        | 厨房灯，多2键绑场景                       |
| 公卫   | 2路     | **四键** | +2        | 顶灯+镜前灯，多2键绑场景                  |
| 主卫   | 1路     | **三键** | +2        | 顶灯，多2键绑场景                         |
| 走廊   | 1路     | **三键** | +2        | 走廊灯，多2键绑"全屋关灯"等               |
| 阳台   | 1路     | **三键** | +2        | 阳台灯，多2键绑窗帘开合等                  |

::: tip 多键策略说明
- 多出来的键通过米家 App「智能→自动化」绑定为场景按钮
- 单击/双击/长按 三种操作 × 多出键数 = 大量可编程组合
- 后期转智能灯时，开关变成纯场景控制器，可玩性极高
- 全屋多花约 280 元，换来 28 个可编程场景按钮
:::
...
|--------|--------------------|-----------------------|---------|
| 客厅   | 门口 四键 E3 Pro   | 走廊入口 四键 E3 Pro   | 79 元   |
| 主卧   | 门口 四键 E3 Pro   | 床头 四键 E3 Pro       | 79 元   |
| 卧室A  | 门口 四键 E3 Pro   | 床头 四键 E3 Pro       | 79 元   |
| 卧室B  | 门口 四键 E3 Pro   | 床头 四键 E3 Pro       | 79 元   |
| 走廊   | 一端 三键 E3 Pro   | 另一端 三键 E3 Pro     | 69 元   |
| **副位合计** | —            | **5 个**              | **385 元** |

副位开关和主位一模一样：AG 玻璃面板、物理按键、Mesh 2.0。两边手感完全一致，比无线开关体验好。
副位多出来的场景键特别适合绑定"睡眠模式""全屋关灯"等高频场景（如床头一键关灯）。
...
| 设备 | 数量 | 型号 |
|------|------|------|
| 有线开关 | 15 个 | 领普 E3 Pro 多键版（主位10+双控副位5，三键×6+四键×9） |
