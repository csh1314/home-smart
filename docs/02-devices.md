...
| 方案                    | 参考价   | 特点                                              |
|-------------------------|---------|--------------------------------------------------|
| **Xiaomi智能音箱Pro（推荐）** | ~270 元 | Mesh 2.0网关 + 超级小爱 + 红外；6麦阵列10米拾音，音质好 |
| Xiaomi智能音箱（预算紧选它）   | ~199 元 | Mesh 2.0网关 + 超级小爱，无红外                      |
| 小米BE6500Pro路由         | ~500 元 | 路由+中枢网关+Mesh网关三合一；适合重度用户，预算要求高    |
| 小米蓝牙Mesh网关          | ~60 元  | 最便宜，但没有语音功能                                |
| ~~老款小爱音箱Pro~~       | ~199 元 | Mesh 1.0，已逐步停产，**不推荐**                      |

推荐 → **Xiaomi智能音箱Pro**（2025年2月新款）。理由 → Mesh 2.0 更稳定 + 超级小爱大模型连续对话 + 红外控制空调电视
...
| 方案           | 预算    | 配置                                                     |
|---------------|---------|----------------------------------------------------------|
| **推荐方案（够用）** | +65 元 | 客厅：Xiaomi智能音箱Pro（网关+语音）；主卧：小爱音箱 mini（~65元，纯语音）→ 两个最常用的位置都能语音控制 |
...
::: warning 很多人以为音箱 Pro 就是中枢网关，这是误解！
:::
...
大促时一起买：中枢网关(~210元) + 2个ES5(~120元) + 走廊传感器(~45元) = 约 375 元，解锁本地自动化 + 全屋传感器联动
:::
...
graph TD
    ...
    P -->|"蓝牙 Mesh 2.0"| S["有线开关 x15\n（E3 Pro，主位10+副位5）"]
    P -->|"蓝牙 Mesh 2.0"| C["窗帘电机 x2\n（mini4）"]
```
